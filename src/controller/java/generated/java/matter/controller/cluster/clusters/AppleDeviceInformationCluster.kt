...
class AppleDeviceInformationCluster(
  ...
  suspend fun readSupportsWEDAttribute(): Boolean? {
    ...
    requireNotNull(attributeData) { "Supportswed attribute not found in response" }
  ...
  suspend fun subscribeSupportsWEDAttribute(
    minInterval: Int,
    maxInterval: Int,
    ...
    return controller.subscribe(subscribeRequest).transform { subscriptionState ->
      when (subscriptionState) {
        ...
        is SubscriptionState.NodeStateUpdate -> {
          ...
          requireNotNull(attributeData) { "Supportswed attribute not found in Node State update" }
  ...
  companion object {
    private val logger = Logger.getLogger(AppleDeviceInformationCluster::class.java.name)
    const val CLUSTER_ID: UInt = 323615744u
  }
}
